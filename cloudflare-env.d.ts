/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: ee3639bb4503d6f5b236e38d6a2a77a1)
// Runtime types generated with workerd@1.20260820.1 2026-06-05 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	WORLDSIM_KV: KVNamespace;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SITE_VERSION: "2026.08.22.003";
	WORKER_SELF_REFERENCE: Fetcher /* matthewtech */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_VERSION">> {}
}
